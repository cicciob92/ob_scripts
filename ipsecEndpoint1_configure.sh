...
peer_user_net=echo $ipsecEndpoint1_private | awk -F "." '{OFS = ".";}{print $1,$2,$3,"0/24"}'
...
echo "add $altra $ipsecEndpoint1_altra esp 0x1001 -m tunnel -u 100	-E aes-cbc 0xaa112233445566778811223344556677;" > setKey.conf
echo "add $ipsecEndpoint1_altra $altra esp 0x2001 -m tunnel -u 101 -E aes-cbc 0xbb112233445566778811223344556677;" >> setKey.conf
echo "spdadd $user_net $external_net any -P out ipsec esp/tunnel/$altra-$ipsecEndpoint1_altra/unique:100;" >> setKey.conf
echo "spdadd $external_net $user_net any -P in ipsec esp/tunnel/$ipsecEndpoint1_altra-$altra/unique:101;" >> setKey.conf
